...
def process_new_item(item_id):
    ...
    """
    # Create an app context so the background thread can talk to the database
    ...
    with app.app_context():
        ...
        try:
            ...
            task_logger.error(f"Failed embedding generation for item {item_id}. Error: {e}")
            return
        ...
        # Free Tier Mock for Police Alert
