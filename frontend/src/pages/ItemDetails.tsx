...
const ItemDetails = () => {
  ...
  const getBestMatchScore = () => {
    return (Array.isArray(matches) && matches.length > 0) ? `${Math.round(matches[0].score * 100)}%` : "N/A";
  }
          ...
          <div className="space-y-6">
            <Card className="card-elegant">
              <CardHeader>
                ...
                <CardDescription>
                  AI found {Array.isArray(matches) ? matches.length : 0} potential matches
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    <div className="text-lg font-semibold flex items-center justify-center gap-1">
                      ...
                      {globalStats?.total_items || 0}
                    </div> 
                    <div className="text-xs text-muted-foreground">Items Processed</div>
                  </div>
                  <div>
                    <div className="text-lg font-semibold">{(Array.isArray(matches) ? matches : []).length}</div> 
